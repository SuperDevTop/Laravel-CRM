...
class SEPAGroupHeader {
  ...
  public function getXmlGroupHeader()
  {
    ...
    $initgPty = $xml->addChild('InitgPty');
    $initgPty->addChild('Nm', $this->getInitiatingPartyName());
    $initgPtyId = $initgPty->addChild('Id');
    $initgPtyOrgId = $initgPtyId->addChild('OrgId');
    $initgPtyOthr = $initgPtyOrgId->addChild('Othr');
    $initgPtyyOthrId = $initgPtyOthr->addChild('Id', Settings::setting('sepa_creditor_scheme_identification'));
