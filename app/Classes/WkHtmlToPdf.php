...
class WkHtmlToPdf
{
    // protected $binPath = '/usr/local/bin/wkhtmltopdf';
    protected $binPath = 'C:/wkhtmltopdf/bin';
    protected $binName = 'wkhtmltopd';
    ...
    protected $xvfbRunOptions = ' --server-args="-screen 0, 1920x1080x24" ';
    ...
    public function __construct($options=array())
    {
        ...
        if (App::environment() == 'production')
            $this->binPath = '/usr/local/bin/wkhtmltopdf';
    }
