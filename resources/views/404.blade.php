...
<head>
	...
	<title>Pepper CRM - 404 Not Found</title>
	...
	<style>
		body {
			...
			background-image: url('../img/layout/error-page-bg.png');
...
<body>
	<div id="main-wrapper">
		<div id="cogs-wrapper">
			<img src='/img/layout/404-monkey.png'>
		</div>
		<div id="text-wrapper">
			<h1>Whoops, that's a 404!</h1>
			<p>
				Don't panic. Although it seems Pepper has vanished, our highly-skilled team or tech-monkeys are already looking for the page.<br>In all seriousness... This page has been deleted, moved, or never existed. If you believe this is an error, please contact us via the orange 'Help & feedback' button on the bottom-left of Pepper.
			</p>
