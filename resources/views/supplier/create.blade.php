		...
		<div class="bit-3">
			<div class="container">
				...
				<div class="container_content">
						<table class="form">
							<tr>
								<td style='width: 120px;'>Supplier code</td>
							...
							<tr class="pt">
								<td>Payment Terms</td>
								<td>{{ Form::select('paymentTerms', PaymentTerm::pluck('type', 'id')) }}</td>
							</tr>
							<tr>
								<td>Payment Type</td>
								<td>{{ Form::select('paymentType', PayMethod::pluck('type', 'id')) }}</td>
							</tr>
							<tr>
								<td>Payment Terms</td>
								<td>{{ Form::select('currency', Currency::pluck('name', 'id')) }}</td>
							</tr>
							<!-- <tr>
								<td>Category</td>
		...
		<div class="bit-3">
			<div class="container">
				...
				<div class="container_content">
					...
					{{ Form::button('<i class="fa fa-save"></i> Create supplier', array('class' => 'btn btn-green fr', 'type' => 'submit'))}}
					<br clear='all'>
				</div>
			</div>
		</div>
