	...
	<body>
		...
		<div id="wrapper">
			...
			<div id="content">
				...
				<table class="styled">
					<tr>
						<td style='width: 45px;' class='first' rowspan='2'><img src='/img/icons/quote/info.png'></td>
						<td style='width: 110px;' class='cellpadding blue'>
							Invoice date:
						</td>
						<td style='width: 100%;' class='cellpadding'>
				...
				<br>
				<?php $counter = 1; ?>
				@foreach($invoice->quoteEntries() as $quoteEntry)
				<h1 class='job_title'>Quote #{{ $quoteEntry->id }}</h1>
					<table class="styled">
						<tr>
					...
					<table class='styled products'>
						...
						<tr>
							...
							@else
								<td colspan='2'><strong style='font-size: 8pt;'>Extra costs:</strong> &euro; {{ number_format($quoteEntry->supCosts, 2, ',', '.') }}</td>
							@endif
				...
				<table class="styled">
					<tr>
						...
						<td class='grey_bg' style='text-align: right; font-size: 8pt; vertical-align: top; width: 100%; padding-top: 15px; padding-bottom: 15px;'>
							<table style='font-size: 8pt; width: 100%;'>
								<tr>
									<td style='text-align: right; width: 60%;'><strong style='font-size: 8pt;'>Subtotal:</strong></td>
									<td style='font-size: 8pt; text-align: right;'>&euro; {{ CommonFunctions::formatNumber($invoice->getSubtotal()) }}</td>
								</tr>
								<tr>
									<td style='text-align: right; width: 40%;'><strong style='font-size: 8pt;'>IVA:</strong></td>
									<td style='font-size: 8pt; text-align: right;'>&euro; {{ CommonFunctions::formatNumber($invoice->getVat()) }}</td>
								</tr>
								<tr>
									<td style='text-align: right; width: 40%;'><strong style='font-size: 8pt;'>Extra costs:</strong></td>
					...
					<tr>
						<td class='first'></td>
						<td colspan='3' style='padding: 10px;'>{{ Settings::setting('bankDetails') }}</td>
					</tr>
					<tr>
						<td class='first'></td>
